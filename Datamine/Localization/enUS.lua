...
L["CONFIG_TOOLTIP_SHOW_APPEARANCE_ID_NAME"] = "Show Item Appearance ID";
L["CONFIG_TOOLTIP_SHOW_APPEARANCE_ID_TOOLTIP"] = "Show item's base appearance ID";
L["CONFIG_TOOLTIP_SHOW_MODIFIED_APPEARANCE_ID_NAME"] = "Show Item Modified Appearance ID";
L["CONFIG_TOOLTIP_SHOW_MODIFIED_APPEARANCE_ID_TOOLTIP"] = "Show item's modified appearance ID";
...
L["MODEL_CONTROLS_TOGGLE_TRANSMOG_SKIN_TOOLTIP_TEXT"] = "Toggle Transmog Skin";
...
L["MODEL_CONTROLS_ADVANCED_SET_CUSTOM_RACEID"] = "Set Custom RaceID";
L["MODEL_CONTROLS_ADVANCED_SET_CUSTOM_RACEID_HELP"] = "Enter a RaceID...";
L["MODEL_CONTROLS_ADVANCED_VIEW_MOUNT"] = "View Mount by ID";
L["MODEL_CONTROLS_ADVANCED_VIEW_MOUNT_HELP"] = "Enter a MountID...";
L["MODEL_CONTROLS_ADVANCED_VIEW_PET"] = "View Pet by DisplayID";
L["MODEL_CONTROLS_ADVANCED_VIEW_PET_HELP"] = "Enter a pet DisplayID...";
L["MODEL_CONTROLS_ADVANCED_VIEW_DECOR"] = "View Decor by ID";
L["MODEL_CONTROLS_ADVANCED_VIEW_DECOR_HELP"] = "Enter a HouseDecorID...";
